 ...
 * @description:
 */
public class FindNewFragment extends Fragment implements OnRefreshListener, View.OnClickListener{
...
//    private FloatingActionButton mFab;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_find_new_love, null);
            setupViews();
            setupEvent();
            setupData();
