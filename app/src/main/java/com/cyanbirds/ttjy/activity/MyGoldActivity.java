...
public class MyGoldActivity extends BaseActivity {
    ...
    @BindView(R.id.iv_ali_recommend)
    ImageView mIvAliRecommend;
    @BindView(R.id.iv_wechat_recommend)
    ImageView mIvWechatRecommend;
    @BindView(R.id.wechat_pay_info)
    TextView mWechatPayInfo;
        ...
        public void onPostExecute(List<MemberBuy> memberBuys) {
            ...
            if (mMemberBuy.isShowAli) {
                ...
                mWechatPayInfo.setText(String.format(
                        getResources().getString(R.string.pay_info_ali),
                        mMemberBuy.descreption));
                mWechatPayInfo.setVisibility(View.VISIBLE);
                mIvWechatRecommend.setVisibility(View.VISIBLE);
            }
            defaultPayWay();
        }
