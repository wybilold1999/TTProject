...
import com.cyanbirds.ttjy.listener.ModifyUserInfoListener;
...
import com.cyanbirds.ttjy.ui.widget.ClearEditText;
...
import static com.cyanbirds.ttjy.config.AppConstants.UPDATE_USER_INFO;
...
//						new PartLableTagAdapter(mVals, mLableFlowlayout));
	...
	private void openCamera() {
		...
		if (intent.resolveActivity(getPackageManager())!=null){
			...
			String mPhotoDirPath = Environment.getExternalStorageDirectory()+"/Android/data/com.cyanbirds.ttjy/files/";
