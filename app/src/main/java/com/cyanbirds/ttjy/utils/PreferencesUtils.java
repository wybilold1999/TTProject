...
public class PreferencesUtils {
	...
	/** 保存登陆账号 */
	public static final String SETTINGS_RL_ACCOUNT = "com.cyanbirds.ttjy_account";
	/** 保存登陆密码 */
	public static final String SETTINGS_RL_PASSWORD = "com.cyanbirds.ttjy_p";
	/** 保存是否第一次启动 */
	public static final String SETTINGS_RL_FIRST_LAUNCHER = "com.cyanbirds.ttjy_first_launcher";
	/** 用户年龄 */
	public static final String SETTINGS_RL_USER_AGE = "com.cyanbirds.ttjy_age";
	/** 头像url */
	public static final String SETTINGS_RL_USER_FACE_URL = "com.cyanbirds.ttjy_face_url";
	/** 手机号 */
	public static final String SETTINGS_RL_USER_MOBILE = "com.cyanbirds.ttjy_mobile";
	/** 个性签名 */
	public static final String SETTINGS_RL_USER_SIGNATURE = "com.cyanbirds.ttjy_signature";
	/** 保存用户性别 */
	public static final String SETTINGS_RL_USER_SEX = "com.cyanbirds.ttjy_sex";
	/** 用户名 */
	public static final String SETTINGS_RL_USER_USER_NAME = "com.cyanbirds.ttjy_user_name";
	/** 某用户是否第一次登录 */
	public static final String SETTINGS_RL_FIRST_LOGIN = "com.cyanbirds.ttjy_first_login";
	/** 是否登录 */
	public static final String SETTINGS_RL_IS_LOGIN = "com.cyanbirds.ttjy_is_login";
	/** 本地头像地址 */
	public static final String SETTINGS_RL_FACE_LOCAL = "com.cyanbirds.ttjy_face_local";
	/**sessionId */
	public static final String SETTINGS_RL_SESSIONID = "com.cyanbirds.ttjy_sessionid";
	/**qq号 */
	public static final String SETTINGS_RL_QQ = "com.cyanbirds.ttjy_qq";
	/**微信号 */
	public static final String SETTINGS_RL_WEIXIN = "com.cyanbirds.ttjy_weixin";
	/**身高 */
	public static final String SETTINGS_RL_TALL = "com.cyanbirds.ttjy_tall";
	/**体重 */
	public static final String SETTINGS_RL_WEIGHT = "com.cyanbirds.ttjy_weight";
	/**距离 */
	public static final String SETTINGS_RL_DISTANCE = "com.cyanbirds.ttjy_distance";
	/**情感状态 */
	public static final String SETTINGS_RL_EMOTION_STATUS = "com.cyanbirds.ttjy_emotion_status";
	/**星座 */
	public static final String SETTINGS_RL_CONSTELLATION = "com.cyanbirds.ttjy_constellation";
	/**城市 */
	public static final String SETTINGS_RL_CITY = "com.cyanbirds.ttjy_city";
	/**职业 */
	public static final String SETTINGS_RL_OCCUPATION = "com.cyanbirds.ttjy_occupation";
	/**教育 */
	public static final String SETTINGS_RL_EDUCATION = "com.cyanbirds.ttjy_education";
	/**交友目的 */
	public static final String SETTINGS_RL_PURPOSE = "com.cyanbirds.ttjy_purpose";
	/**爱爱地点 */
	public static final String SETTINGS_RL_LOVE_WHERE = "com.cyanbirds.ttjy_love_where";
	/**首次见面希望 */
	public static final String SETTINGS_RL_DO_WHAT_FIRST = "com.cyanbirds.ttjy_do_what_first";
	/**恋爱观念 */
	public static final String SETTINGS_RL_CONCEPTION = "com.cyanbirds.ttjy_conception";
	/**是否显示 */
	public static final String SETTINGS_RL_IS_SHOW = "com.cyanbirds.ttjy_is_show";
	/**是否vip */
	public static final String SETTINGS_RL_IS_VIP = "com.cyanbirds.ttjy_is_vip";
	/**isCheckPhone */
	public static final String SETTINGS_RL_IS_CHECK_PHONE = "com.cyanbirds.ttjy_is_check_phone";
	/**publicSocialNumber */
	public static final String SETTINGS_RL_PUBLIC_SOCIALNUMBER = "com.cyanbirds.ttjy_public_socialnumber";
	/** 新消息提醒 */
	public static final String SETTINGS_RL_NEW_MESSAGE_NOTICE = "com.cyanbirds.ttjy_new_message_notice";
	/** 通知显示消息详情 */
	public static final String SETTINGS_RL_NOTICE_MESSAGE_INFO = "com.cyanbirds.ttjy_notice_message_info";
	/** 通知声音*/
	public static final String SETTINGS_RL_NOTICE_VOICE = "com.cyanbirds.ttjy_notice_voice";
	/** 通知震动*/
	public static final String SETTINGS_RL_NOTICE_SHOCK = "com.cyanbirds.ttjy_notice_shock";
	/** 听筒播放*/
	public static final String SETTINGS_RL_EARPIECE_PLAY_VOICE = "com.cyanbirds.ttjy_earpiece_play_voice";
	/** 极光推送设置别名是否成功*/
	...
	/** 登录时间*/
	public static final String SETTINGS_LOGIN_TIME = "com.cyanbird.ttjy_login_time";
	/** 我的零钱*/
	...
	/** 是否有领取话费的活动*/
	public static final String SETTINGS_IS_HAS_GET_FARE_ACTIVITY = "com.cyanbirds.ttjy_is_has_get_fare_activity";
	/** 购买的是多少钱的vip*/
	public static final String SETTINGS_WHICH_VIP = "com.cyanbirds.ttjy_which_vip";
	/** 登录的次数*/
	public static final String SETTINGS_LOGIN_COUNT = "com.cyanbirds.ttjy_login_count";
	/** 该月是否可以领取话费*/
